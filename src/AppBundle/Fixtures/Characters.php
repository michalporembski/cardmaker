...
//        ],
    ...
    const CARDS = [
        ...
        [
            'name' => 'Niestrudzony',
            'story' => 'Do boju, bez chwili wytchnienia!',
            'desc' => 'Zamiast rzucać kością za ruch, możesz przesunąć się na dowolny, najbliższy inny obszar w tej Krainie, na którym znajduje się Wróg.',
            'card' => Layer::CARD_ALIGNMENT_GOOD,
        ],
        [
            'name' => 'Ambitny',
            'story' => 'Zawsze chcesz zwyciężać, nigdy jednak nie posuniesz się do przeklinania swych wrogów.',
            'desc' => 'Ujawniając kartę Charakteru, otrzymujesz 2 punkty Losu.' . "\n---\n" . 'Każdy twój rzut kością, możesz przerzucić drugi raz za pomocą Losu. Nie możesz używać ciemnej strony Losu. Wszystkie posiadane punkty Losu musisz przewracać na jasną stronę.',
            'card' => Layer::CARD_ALIGNMENT_GOOD,
        ],
        [
            'name' => 'Nieufny',
            'story' => 'Nikomu nie ufaj.',
            'desc' => 'Żaden z twoich Przyjaciół nigdy cię nie zaatakuje, nigdy też nie stracisz przedmiotu ani złota z powodu Przyjaciela. Żaden Przyjaciel nie przyłączy się do ciebie wbrew twojej woli.',
...
//            'desc' => 'Na początku każdej tury, możesz odzyskać punkt Losu. Nie, możesz używać punktów jasnej strony Losu, ale, możesz je odrzucać.',
        ...
        [
            'name' => 'Żałosny',
            'story' => 'Nie potrafisz nawet przegrać z godnością',
            'desc' => 'Gdy zostaniesz pokonany w jakiejkolwiek walce przez Dobrego lub Neutralnego Poszukiwacza, będzie on musiał zmienić Charakter na Zły.' . "\n---\n" . 'Rozpatrując karty Wrogów sam decydujesz jaki mają numer spotkania.',
            'card' => Layer::CARD_ALIGNMENT_NEUTRAL,
        ],
        [// przeciwnik, czy istota?
            'name' => 'Wytrwały',
...
//            'desc' => 'Aby pokonać cię w Walce przeciwnik musi uzyskać skuteczność ataku większą o 2. Jeżeli przewaga będzie mniejsza, walka kończy się remisem.',
            'desc' => 'Aby pokonać cię w walce, skuteczność ataku przeciwnika musi być przynajmniej 2 punkty wyższa.',
            'card' => Layer::CARD_ALIGNMENT_NEUTRAL,
        ],
        //        [
        //            'name' => 'Pokutny',
        ...
        [
            'name' => 'Zbieracki',
            'story' => 'Nie zostawisz niczego.',
            'desc' => 'Za każdym razem, gdy podczas ruchu przechodzisz przez obszar na którym znajduje się przynajmniej jeden przedmiot, możesz zakończyć ruch na tym obszarze.',
            'card' => Layer::CARD_ALIGNMENT_NEUTRAL,
        ],
        [
            'name' => 'Łaskawy',
            'story' => 'Nie ma w Tobie żądzy krwi.',
            'desc' => 'Gdy wygrasz jakąkolwiek walkę, możesz zrezygnować z normalnej nagrody. Zyskasz wtedy punkt Losu.',
            'card' => Layer::CARD_ALIGNMENT_NEUTRAL,
        ],
        [
            'name' => 'Zachłanny',
...
//            'desc' => 'Ujawniając Charakter, odzyskujesz wszystkie punkty Losu.' . "\n---\n" . 'Gdy wykorzystujesz punkt ciemnej strony Losu, możesz przerzucić dowolną ilość nie swoich kości.',
        ...
        [
            ...
            'desc' => 'Odbywając spotkanie z Nieznajomym, możesz potraktować jego kartę jakby był Wrogiem o Sile 0. Rzuć trzema kośćmi, aby określić skuteczność ataku Nieznajomego. Jeżeli wygrasz, a skuteczność ataku Nieznajomego przekroczy 10, jako nagrodę otrzymasz punkt Siły.',
            'card' => Layer::CARD_ALIGNMENT_EVIL,
        ],
//        [
...
//        ],
//        [
//            'name' => 'Ekscentryczny Kolekcjoner',
//            'places' => ['Zamek', 'Miasto'],
//            'desc' => 'Ekscentryczny Kolekcjoner oferuje ci 2 sztuki złota za każdy Magiczny Przedmiot, jeżeli przedmiot jest przeklęty dostaniesz za niego 3 sztuki złota.',
//            'card' => Layer::CARD_DENIZEN,
//        ],
//        [
...
//            'desc' => 'Tylko posiadając jeden z legendarnych Talizmanów, możesz wkroczyć do Doliny Ognia.' . "\n---\n" . 'Nie możesz zmienić Charakteru wbrew swojej woli. Za każdym razem, gdy jakiś efekt nakaże ci zmienić Charakter, otrzymujesz punkt Życia.',
...
//            'name' => 'Wielki Ucisk',
//            'tag' => 'Księżycowe Zdarzenie',
//            'desc' => 'Po odkryciu tej karty, odwróć kartę Czasu na stronę Dnia.' . "\n---\n" . 'Po zakończeniu swojego ruchu, każdy dobry Poszukiwacz, musi przesunąć najbliższego Wroga z tej samej krainy na swój obszar. Jeśli dwóch lub więcej Wrogów jest oddalonych o taką samą liczbę obszarów, Poszukiwacz wybiera którego z tych Wrogów przesunie.' . "\n---\n" . 'Odrzuć tę kartę, kiedy zapada Noc.',
//            'card' => Layer::CARD_ADVENTURES,
...
//            'tag' => 'Księżycowe Zdarzenie',
//            'desc' => 'Po odkryciu tej karty, odwróć kartę Czasu na stronę Nocy.' . "\n---\n" . 'Żaden Poszukiwacz nie może zmienić Charakteru. Wszystkie efekty zmiany Charakteru należy ignorować.' . "\n---\n" . 'Odrzuć tę kartę, kiedy wstaje Dzień.',
//            'card' => Layer::CARD_ADVENTURES,
...
//            'caption' => 'Przeklęty',
//            'tag' => 'Przyjaciel',
//            'desc' => 'Kusicielka nigdy nie przyłączy się do Złego Poszukiwacza.' . "\n---\n" . 'Pod koniec każdej tury wylosuj kartę Charakteru, możesz ją zachować odrzucając swoją aktualną kartę Charakteru. Gdy się na to zdecydujesz porzuć Kusicielkę na obszarze na którym się znajdujesz.',
//            'card' => Layer::CARD_WOODLAND,
...
//        ],
//        [
//            'name' => 'Magiczna Biblioteka',
//            'tag' => 'Miejsce',
//            'desc' => 'Trafiłeś do Magicznej Biblioteki. Miejscowa czarodziejka oferuje ci sprzedać Zaklęcie za 2 sztuki złota. Jeżeli się na to zdecydujesz dobierz 3 Zaklęcia, zachowaj jedno a pozostałe odrzuć, o ile pozwala ci na to Moc.',
//            'card' => Layer::CARD_DUNGEON,
//            'image' => './charaktery/magic_shop.jpg',
//            'level' => 6
//        ],
//        [
...
//            'tag' => 'Magiczny Przedmiot',
//            'desc' => 'Jeżeli pokonasz Złego lub Neutralnego Poszukiwacza w jakiejkolwiek walce, oprócz zwykłej nagrody, możesz zmienić jego Charakter na dobry.',
...
//            'tag' => 'Nieznajomy',
//            'desc' => 'Napotkałeś Widzącą Wiedźmę która przejrzała cię na wskroś. Ujawnij swoją kartę Charakteru lub odrzuć punkt Życia. Następnie Widząca Wiedźma udaje się na stos kart odrzuconych.',
...
//Potrafisz przewidywać przyszłość. Gdy miałbyś
//wykonać rzut kością, możesz najpierw wykonać
//próbny rzut, aby sprawdzić ile wyniesie wynik.
//Rzut kością którego wynik przewidziałeś nie musi
//się odbyć, jeżeli jednak zdecydujesz się przewidzieć
//wynik rzutu, nie będzie można go przerzucić za
//pomocą losu. Możesz tego dokonać tylko dwa razy
//na rundę.
...
//tylko raz na turę.
//
//Potrafisz przewidywać przyszłość. Gdy dowolny
//Poszukiwacz miałby wykonać rzut kością, możesz
//przewidzieć jaki wynik uzyska, aby to zrobić
//rzuć kością. Rzut kością którego wynik
//przewidziałeś nie musi się odbyć, jeżeli jednak
//zdecydujesz się przewidzieć wynik, nie będzie
//można go przerzucić za pomocą losu. Możesz tego
//dokonać tylko dwa razy na rundę.
